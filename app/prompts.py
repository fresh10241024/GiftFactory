...
{{
  ...
  "visual": "视觉方向描述",
  "interaction": "交互设计描述",
  "technique": "选用2-3个技术效果（从以下选：kinetic_text|particle_system|magnetic_btn|cursor_trail|ripple|tilt_3d|mesh_gradient|glitch|noise_texture|vignette|svg_morph|counter|spring_anim|duotone|light_bleed）",
  "atmosphere": "情感氛围",
  "opening": "开场动效描述",
  "color_palette": ["主色", "辅色", "背景色"],
